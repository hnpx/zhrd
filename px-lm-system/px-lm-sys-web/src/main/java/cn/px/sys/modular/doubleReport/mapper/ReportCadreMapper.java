...
public interface ReportCadreMapper extends BaseMapperImpl<ReportCadreEntity> {
     ...
     * @return
     */
    public Page<Map<String,Object>> getListHome(@Param("page") Page page,@Param("name") String name,@Param("phone") String phone,@Param("cid") Long cid,@Param("belongingCommunity") Long  belongingCommunity,@Param("belongingUnit") Long belongingUnit);
