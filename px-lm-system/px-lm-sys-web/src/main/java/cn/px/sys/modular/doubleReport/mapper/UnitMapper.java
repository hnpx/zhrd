...
public interface UnitMapper extends BaseMapperImpl<UnitEntity> {
     ...
     * @return
     */
    Page<Map<String,Object>> getList(@Param("page") Page page,@Param("name") String name,@Param("cid") Long cid,@Param("contactPerson") String contactPerson,@Param("belongingCommunity") Long belongingCommunity);
