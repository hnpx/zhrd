...
public class MemberService extends BaseServiceImpl<MemberEntity, MemberMapper> {
     ...
     * @return
     */
    public Page<Map<String,Object>> getListPage(String name, String phone,Long userId,Long belongingCommunity,Long belongingUnit ){
        ...
        return super.mapper.getListPage(page,name,phone,cid,belongingCommunity,belongingUnit);
    }
}