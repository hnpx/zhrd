...
public class IntegralRecordApiController extends BaseController<IntegralRecordEntity, IntegralRecordService> {
    ...
    public Object FindIntergralList(
    ...
    public Object FindIntergralListByOrganization(
        ...
        Page page1 = new Page(page,pageSize);
        RecordApiVo vo = new RecordApiVo();
        Page<Map<String,Object>> integralRecord = super.service.FindIntergralListByOrganization(page1);
        vo.setPage(integralRecord);
        Long userId =  LoginContextHolder.getContext().getUserId();
        if (userId!=null){
    ...
    public Object VolunteerRanking(
            @RequestParam("page") Integer page,
            @RequestParam(value = "pageSize") Integer pageSize
    ){
        Page page1 = new Page(page,pageSize);
        return setSuccessModelMap(service.VolunteerRanking(page1));
    }

    @GetMapping("/unitRanking")
    public Object unitRanking(
            @RequestParam("page") Integer page,
            @RequestParam(value = "pageSize") Integer pageSize
    ){
        Page page1 = new Page(page,pageSize);
        return setSuccessModelMap(service.unitRanking(page1));
    }

    @GetMapping("/memberRanking")
    public Object memberRanking(
            @RequestParam("page") Integer page,
            @RequestParam(value = "pageSize") Integer pageSize
    ){
        Page page1 = new Page(page,pageSize);
        return setSuccessModelMap(service.memberRanking(page1));
    }
