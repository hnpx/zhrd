...
public interface ActivityMapper extends BaseMapperImpl<ActivityEntity> {
    ...
    Page<Map<String,Object>> getActivity(@Param("page") Page page, @Param("name") String name,
                                         ...
                                         @Param("timeStatus") Integer timeStatus,@Param("month") String month);
     ...
     * @return
     */
    Page<Map<String,Object>> getActivityWx1(@Param("page") Page page, @Param("date") Date date, @Param("timeStatus")Integer timeStatus);
