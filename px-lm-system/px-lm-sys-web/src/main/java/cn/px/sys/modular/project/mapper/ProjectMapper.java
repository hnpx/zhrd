...
public interface ProjectMapper extends BaseMapperImpl<ProjectEntity> {
    ...
    Page<Map<String,Object>> getListPage(@Param("page") Page page,@Param("name") String name,@Param("cid") Long cid,@Param("contactPerson") String contactPerson,
                                         @Param("phone") String phone,@Param("timeStatus") Integer timeStatus,@Param("month") String month);
     ...
     * @return
     */
    Page<Map<String,Object>> getListPage1(@Param("page") Page page,@Param("cid") Long cid,@Param("date") Date date,
    @Param("timeStatus")Integer timeStatus);
     ...
     * @return
     */
    Page<Map<String,Object>> getListPage2(@Param("page") Page page,@Param("cid") Long cid,@Param("date") Date date,
                                          @Param("timeStatus")Integer timeStatus);
