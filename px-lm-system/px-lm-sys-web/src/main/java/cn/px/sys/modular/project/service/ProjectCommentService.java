...
public class ProjectCommentService extends BaseServiceImpl<ProjectCommentEntity, ProjectCommentMapper> {
     ...
     * @return
     */
    public Page<Map<String,Object>> getPageList(Integer page,Integer pageSize,Long projectId,String nickname){
        Page page1;
        if(pageSize != null){
        ...
        return super.mapper.getPageList(page1,projectId,nickname);
    }
