    ...
    MgrUser.initColumn = function () {
        ...
        return [[
          ...
          /*  {field: 'account', align: "center", sort: true, title: langs.FIELD_ACCOUNT},
            ...
            /*  {field: 'deptName', align: "center", sort: true, title: '部门名字'},
          {field: 'positionName', align: "center", sort: true, title:'职位名字' },*/
            {field: 'phone', align: "center", sort: true, title:'手机号', minWidth: 117},
            {field: 'createTime', align: "center", sort: true, title: '创建时间', minWidth: 160,templet : "<div>{{layui.util.toDateString(d.createTime, 'yyyy-MM-dd')}}</div>"},
